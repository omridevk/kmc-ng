        ...
        var switchTemplate = 
            '<span ng-switch on="getType(val)" >'
                ...
                + '<span ng-switch-when="Boolean" type="boolean">'
                    + '<input type="checkbox" ng-model="val" ng-model-onblur ng-change="child[key] = val;reportChange()">'
                + '</span>'
                + '<span ng-switch-default class="jsonLiteral"><input type="text" ng-model="val" '
                    + 'placeholder="Empty" ng-model-onblur ng-change="child[key] = possibleNumber(val);reportChange()"/>'
                + '</span>'
            + '</span>';
            ...
            + '<div class="jsonContents" ng-hide="collapsed">'
                ...
                + '<span class="block" ng-hide="key.indexOf(\'_\') == 0" ng-repeat="(key, val) in child">'
                    ...
                    + '<span class="jsonObjectKey">'
                        + '<input class="keyinput" type="text" ng-change="reportChange()" ng-model="newkey" ng-init="newkey=key" '
